...
/// </summary>
/// <remarks>
/// These extension methods enable serialization and deserialization of <see cref="ChartInteractionService"/> instances.
/// Note: Due to constructor dependencies, deserialized instances will not have their dependencies properly initialized.
/// </remarks>
public static class ChartInteractionServiceJsonExtensions
{
	...
	/// <returns>A deserialized <see cref="ChartInteractionService"/> instance, or null if the JSON is invalid or deserialization fails.</returns>
	/// <remarks>
	/// Note: <see cref="ChartInteractionService"/> has constructor dependencies that prevent proper deserialization.
	/// This method returns null if deserialization fails.
	/// </remarks>
	...
	public static bool TryFromJson(
		string json,
		[NotNullWhen(true)] out ChartInteractionService? value)
	{
		ArgumentNullException.ThrowIfNull(json);
		ArgumentException.ThrowIfNullOrEmpty(json.Trim());
