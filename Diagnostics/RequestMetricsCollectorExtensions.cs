...
/// <summary>
/// Extension methods for <see cref="RequestMetricsCollector"/> providing additional metric analysis capabilities
/// </summary>
public static class RequestMetricsCollectorExtensions
{
	...
	/// <param name="count">Number of top endpoints to return. Must be greater than zero.</param>
	/// <returns>Collection of endpoint metrics ordered by request count in descending order.</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="collector"/> is <see langword="null"/>.</exception>
	...
	/// </summary>
	/// <param name="collector">The metrics collector instance.</param>
	/// <param name="count">Number of endpoints to return. Must be greater than zero.</param>
	/// <returns>Collection of endpoint metrics ordered by error rate in ascending order (lowest success rates first).</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="collector"/> is <see langword="null"/>.</exception>
	/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="count"/> is less than 1.</exception>
	...
	/// </summary>
	/// <param name="collector">The metrics collector instance.</param>
	/// <param name="thresholdMs">Response time threshold in milliseconds. Must be greater than zero.</param>
	/// <returns>Collection of endpoint metrics that exceed the threshold, ordered by response time in descending order.</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="collector"/> is <see langword="null"/>.</exception>
	...
	/// </summary>
	/// <param name="collector">The metrics collector instance.</param>
	/// <param name="cultureInfo">Culture info for formatting numbers. Defaults to <see cref="CultureInfo.InvariantCulture"/>.</param>
